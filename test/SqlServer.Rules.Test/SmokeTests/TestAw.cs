...
public class TestAW : TestModel
{
    ...
    public void TestAdventureworks()
    {
        ...
        ExpectedProblems.Add(new TestProblem(23, 6, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(24, 13, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(28, 16, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(15, 6, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(16, 13, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(20, 16, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(22, 45, "SqlServer.Rules.SRP0009"));
        ExpectedProblems.Add(new TestProblem(16, 6, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(17, 13, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(21, 16, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(23, 16, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(24, 16, "SqlServer.Rules.SRD0020"));
        ExpectedProblems.Add(new TestProblem(23, 6, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(26, 16, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(34, 13, "SqlServer.Rules.SRD0078"));
        ...
        ExpectedProblems.Add(new TestProblem(2, 1, "SqlServer.Rules.SRD0067"));
        ExpectedProblems.Add(new TestProblem(2, 1, "SqlServer.Rules.SRD0067"));
        ExpectedProblems.Add(new TestProblem(30, 6, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(12, 6, "SqlServer.Rules.SRD0078"));
        ...
        ExpectedProblems.Add(new TestProblem(27, 6, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(28, 16, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(30, 13, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(34, 16, "SqlServer.Rules.SRD0078"));
        ...
        ExpectedProblems.Add(new TestProblem(24, 20, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(26, 14, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(14, 16, "SqlServer.Rules.SRD0020"));
        ExpectedProblems.Add(new TestProblem(13, 6, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(16, 16, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(17, 16, "SqlServer.Rules.SRD0020"));
        ExpectedProblems.Add(new TestProblem(16, 6, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(21, 13, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(26, 6, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(14, 16, "SqlServer.Rules.SRD0020"));
        ExpectedProblems.Add(new TestProblem(13, 6, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(16, 16, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(17, 16, "SqlServer.Rules.SRD0020"));
        ...
        ExpectedProblems.Add(new TestProblem(15, 10, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(2, 1, "SqlServer.Rules.SRD0067"));
        ExpectedProblems.Add(new TestProblem(2, 1, "SqlServer.Rules.SRD0067"));
        ExpectedProblems.Add(new TestProblem(9, 10, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(2, 1, "SqlServer.Rules.SRD0067"));
        ExpectedProblems.Add(new TestProblem(2, 1, "SqlServer.Rules.SRD0067"));
        ExpectedProblems.Add(new TestProblem(10, 10, "SqlServer.Rules.SRD0078"));
        ...
        ExpectedProblems.Add(new TestProblem(2, 1, "SqlServer.Rules.SRD0067"));
        ExpectedProblems.Add(new TestProblem(2, 1, "SqlServer.Rules.SRD0067"));
        ExpectedProblems.Add(new TestProblem(18, 27, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(22, 10, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(23, 17, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(27, 27, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(33, 10, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(38, 17, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(42, 27, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(48, 10, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(53, 17, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(57, 27, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(58, 17, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(63, 10, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(64, 17, "SqlServer.Rules.SRD0078"));
        ...
        ExpectedProblems.Add(new TestProblem(12, 5, "SqlServer.Rules.SRD0068"));
        ExpectedProblems.Add(new TestProblem(33, 10, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(15, 14, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(16, 24, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(24, 24, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(26, 24, "SqlServer.Rules.SRD0078"));
        ...
        ExpectedProblems.Add(new TestProblem(28, 20, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(30, 20, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(12, 14, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(13, 15, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(18, 14, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(21, 24, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(9, 5, "SqlServer.Rules.SRD0028"));
        ExpectedProblems.Add(new TestProblem(27, 10, "SqlServer.Rules.SRD0038"));
        ExpectedProblems.Add(new TestProblem(2, 1, "SqlServer.Rules.SRD0067"));
        ExpectedProblems.Add(new TestProblem(9, 5, "SqlServer.Rules.SRD0068"));
        ExpectedProblems.Add(new TestProblem(28, 20, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(30, 15, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(12, 14, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(13, 15, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(18, 14, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(21, 15, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(10, 5, "SqlServer.Rules.SRD0068"));
        ExpectedProblems.Add(new TestProblem(31, 10, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(13, 14, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(14, 24, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(22, 24, "SqlServer.Rules.SRD0078"));
        ExpectedProblems.Add(new TestProblem(24, 24, "SqlServer.Rules.SRD0078"));
