...
namespace SqlServer.Rules.Design
{
    ...
    public sealed class SingleCharacterAliasRule : BaseSqlCodeAnalysisRule
    {
        /// <summary>
        /// The rule identifier
        /// </summary>
        public const string RuleId = Constants.RuleNameSpace + "SRD0078";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleCharacterAliasRule"/> class.
        /// </summary>
        public SingleCharacterAliasRule()
        ...
        public override IList<SqlRuleProblem> Analyze(SqlRuleExecutionContext ruleExecutionContext)
        {
            ...
            var visitor = new TableReferenceWithAliasVisitor();
            fragment.Accept(visitor);

            var offenders = visitor.NotIgnoredStatements(RuleId)
                .Where(t => t.Alias != null && t.Alias.Value.Length == 1);
